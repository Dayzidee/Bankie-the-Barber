      ...
      gsap.to(
        { value: 0 },
        {
          ...
          onUpdate: function () {
            ...
            numberElement.textContent =
              currentValue + (hasPlus ? "+" : "") + (hasPercent ? "%" : "");
          },
          scrollTrigger: {
            trigger: stat,
            start: "top 85%",
...
function initializeContactForm() {
  ...
  contactForm.addEventListener("submit", async function (e) {
    ...
    // Optionally, also submit to Formspree if action/method present
    if (contactForm.action && contactForm.method && status) {
...
function initializeScrollEffects() {
  ...
  scrollProgress.style.cssText = `
        ...
        width: 0%;
        height: 3px;
        background: linear-gradient(90deg, #111111, #ffffff);
        z-index: 9999;
...
loaderText.textContent = "BANKIETHEBARBER";
loaderText.style.cssText = `
    font-family: 'Oswald', sans-serif;
    font-size: 2rem;
    background: linear-gradient(90deg, #444444, #999999);
